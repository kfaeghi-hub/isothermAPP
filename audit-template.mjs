...
const RULED_KEYS = ['ahu', 'pump', 'fan', 'fcu', 'heat_pump', 'chiller', 'cooling_tower', 'boiler', 'erv', 'generator', 'vav', 'ats']
const FIELD_DEF_KEYS = ['ahu', 'ats', 'boiler', 'chiller', 'cooling_tower', 'erv', 'fan', 'fcu', 'generator', 'heat_pump', 'pump', 'vav']
