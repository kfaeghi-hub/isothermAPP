...
export function ApplicabilityReview({ projectId, onApplied }: {
  ...
  /** CLASSIFICATION IS A JOB, NOT A REQUEST — and that was measured, not assumed.
   *  A full pass is 13 bounded calls, several needing a retry at a larger ceiling;
   *  the platform caps a function at 60s (it dies at 60.3s) and no setting raises
   *  it. An administrator runs `classify-project.mjs`, and the proposals appear
   *  here. Offering a button that always times out would be worse than offering
   *  none. */
  ...
  return (
    <div className="px-6 py-4">
      <div className="flex items-center gap-3 mb-2">
        ...
        <span className="text-[11px] text-gray-400" title="node --env-file=.env classify-project.mjs <com_number>">
          proposals are generated by an administrator job
        </span>
        {rules.length > 0 && (
