...
- **Word COM environment flag (2026-07-21)**: Documents.Open hangs machine-wide (even on previously convertible files; ShareSync Office Plugin implicated, disabling insufficient) — needs Tony's desktop attention before the Start-Up campaign's Word extractions.
